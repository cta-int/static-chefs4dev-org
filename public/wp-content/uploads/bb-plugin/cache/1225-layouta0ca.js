...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);jQuery(function($){$(function(){$('.fl-node-5838117c2eadc .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});(function($){$(function(){if(typeof $.fn.magnificPopup!=='undefined'){$('.fl-node-58381f4ed0bcf .fl-mosaicflow-content, .fl-node-58381f4ed0bcf .fl-gallery').magnificPopup({delegate:'.fl-photo-content > a',closeBtnInside:false,type:'image',gallery:{enabled:true,navigateByImgClick:true,},'image':{titleSrc:function(item){}},callbacks:{open:function(){if(this.items.length>0){var parent,item,newIndex=0,newItems=[];$(this.items).each(function(i,data){item=$(this);if('undefined'!==typeof this.el){item=this.el;}
...
$('.fl-node-58381f4ed0bcf .fl-mosaicflow-content').one('filled',function(){var hash=window.location.hash.replace('#','');if(hash!=''){FLBuilderLayout._scrollToElement($('#'+hash));}
